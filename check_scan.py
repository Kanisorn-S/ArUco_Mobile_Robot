...
def scan(servo, motor_channel_left, motor_channel_right, vl, vr, cap, N_ARUCO, t_aruco, rel_dis, SCAN_TIME, R, BASELINE, MAX_SPEED, aruco_dict, camera_matrix, camera_distortion, marker_size, t_bot, n_aruco):
    # 360 Scan
    print("scanning")
